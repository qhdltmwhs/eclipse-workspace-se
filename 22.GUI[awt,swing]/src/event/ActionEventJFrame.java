...
public class ActionEventJFrame extends JFrame {
	...
	public ActionEventJFrame() {
		...
		//프레임에 생성한 JPanel 객체 추가
		this.setContentPane(contentPane);
		// 추가한 JPanel객체의 레이아웃 속성과 백그라운드 속성을 속성객체생성으로 셋팅
		...
		*/
		/**********같은이벤트! Source 여러개를 단일 이벤트핸들러로 처리**********/
