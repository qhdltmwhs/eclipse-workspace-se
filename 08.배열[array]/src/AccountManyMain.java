...
public class AccountManyMain {
	...
	public static void main(String[] args) {
		...
		accountMany.acc1 = new Account(2222, "KIM", 39000, 0.3);
		accountMany.acc2 = new Account(3333, "KIM", 29000, 0.2);
		accountMany.acc3 = new Account(4444, "KIM", 45000, 0.1);
		accountMany.acc4 = new Account(5555, "KIM", 12000, 0.8);
		Account.headerPrint();
